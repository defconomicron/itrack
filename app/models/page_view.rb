  ...
  def self.sub_domains(params)
    ...
    paginate_by_sql("
        ...
        from (
            ...
            select sub_domain, 0 as page_views, 0 as new_visitors, 0 as return_vistors, 0 as visits, sum(unique_visitor) as unique_visitors
            from (
              select
                sub_domain,
                1 as unique_visitor
